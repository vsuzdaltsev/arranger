...
class BasicService(Construct, BasicMixin):
    ...
    @staticmethod
    def _cassandra_metrics_variables() -> Dict[str, str]:
        return {
            "cassandra_node-metrics_0": "pool.open-connections",
            "cassandra_node-metrics_1": "pool.available-streams",
            "cassandra_node-metrics_2": "pool.in-flight",
            "cassandra_node-metrics_3": "pool.orphaned-streams",
            "cassandra_node-metrics_4": "cql-messages",
            "cassandra_node-metrics_5": "errors.request.unsent",
            "cassandra_node-metrics_6": "errors.request.aborted",
            "cassandra_node-metrics_7": "errors.request.write-timeouts",
            "cassandra_node-metrics_8": "errors.request.unavailables",
            "cassandra_node-metrics_9": "errors.request.others",
            "cassandra_node-metrics_10": "retries.total",
            "cassandra_node-metrics_11": "ignores.total",
            "cassandra_node-metrics_12": "speculative-executions",
            "cassandra_node-metrics_13": "errors.connection.init",
            "cassandra_node-metrics_14": "errors.connection.auth",
            "cassandra_node-metrics_15": "graph-messages",
            "cassandra_session-metrics_0": "connected-nodes",
            "cassandra_session-metrics_1": "cql-requests",
            "cassandra_session-metrics_2": "cql-client-timeouts",
            "cassandra_session-metrics_3": "cql-prepared-cache-size",
            "cassandra_session-metrics_4": "continuous-cql-requests",
            "cassandra_session-metrics_5": "graph-client-timeouts",
        }
...
#
# class BasicFrontService(BasicService):
#     def _generate_deployment(
#         self,
#         name=None,
#         patches=None,
...
#         volumes=None,
#         volume_mounts=None,
#         readiness_http_probe=None,
#         startup_http_probe=None,
#         liveness_http_probe=None,
#     ) -> type(k8s.Deployment):
#         name = name or self.service_name
#         container_ports = container_ports or [self.config.CONTAINER_PORT]
#         container_name = container_name or self.service_name
...
#                             **self._common_labels(resource_name=name),
#                         },
#                         annotations={"image": self.config.IMAGE},
#                     ),
#                     spec=k8s.PodSpec(
...
#                                         value_from=k8s.EnvVarSource(
#                                             field_ref=k8s.ObjectFieldSelector(
#                                                 field_path="metadata.annotations['image']"
#                                             )
#                                         ),
#                                     ),
#                                 ],
...
#                                 args=self._args(commands=args),
#                                 volume_mounts=volume_mounts,
#                                 readiness_probe=self._probe(
#                                     probe_metadata=readiness_http_probe
#                                 ),
#                                 liveness_probe=self._probe(
#                                     probe_metadata=liveness_http_probe
#                                 ),
#                                 startup_probe=self._probe(
#                                     probe_metadata=startup_http_probe
#                                 ),
#                             )
#                         ],
#                         volumes=volumes,
...
#
#
# class BasicBackService(BasicService):
#     def _generate_deployment(
#         self,
#         name=None,
#         patches=None,
...
#             _containers = []
#
#             if self.service_name in BasicConf.SERVICES_WITH_KEYSPACES_SWITCH:
#                 _containers.extend(
#                     self.create_keyspaces_init_containers(
#                         resources=self.init_container_resources()
#                     )
#                 )
#
#                 _containers.append(
#                     self.cassandra_common_data_migration_init_container(
#                         resources=self.init_container_resources()
#                     )
#                 )
#
#             if self.service_name in BasicConf.SERVICES_WITH_POSTGRES_SWITCH:
#                 _containers.append(self._container_for_creating_db())
#
#             _containers.extend(init_containers)
#             return _containers
#
...
#         )
#
#         if self.config.JAVA_DEBUG_AGENT:
#             deployment.add_json_patch(
#                 self._add(
#                     route="/spec/template/spec/containers/0/ports/1",
#                     value={"containerPort": 5005},
#                 )
#             ),
#             deployment.add_json_patch(
#                 self._patch(
#                     route=f"/spec/template/spec/containers/0/args",
#                     value=[
...
#             deployment.add_json_patch(
#                 self._patch(
#                     route=f"/spec/template/spec/containers/0/command",
#                     value=["/bin/sh", "-c"],
#                 )
#             )
#
...
#         return deployment
#
#     def _generate_service(self, patches=None, port_name=None) -> type(k8s.Service):
#         def _port_name():
#             if port_name:
#                 return port_name
#
