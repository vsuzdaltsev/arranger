...
from eusy_cdk8s.eusy_services import *
from eusy_conf.app_conf import AppConf
from eusy_conf.eusy_cdk8s_conf import K8sConf
...
class EusyApp(Chart):
    ...
    def all_services(self) -> Dict[str, Any]:
        from eusy_conf.eusy_cdk8s_conf_lib._basic_service import BasicService
